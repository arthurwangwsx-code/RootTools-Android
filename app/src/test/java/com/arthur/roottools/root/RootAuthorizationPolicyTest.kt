...
class RootAuthorizationPolicyTest {
    ...
    fun uidZeroIsGranted() {
        val result = RootAuthorizationPolicy.fromProbe(RootShell.Result(0, "0"))
    ...
    fun timeoutIsNotReportedAsMissingRoot() {
        val result = RootAuthorizationPolicy.fromProbe(RootShell.Result(-1, "", timedOut = true))
    ...
    fun nonRootUidIsDenied() {
        val result = RootAuthorizationPolicy.fromProbe(RootShell.Result(0, "2000"))
